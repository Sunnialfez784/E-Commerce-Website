          ...
          <section className="section-surface p-5 sm:p-6">
            <div className="flex items-end justify-between gap-4 border-b border-slate-200 pb-5">
              <div>
                ...
                <h2 className="mt-2 text-2xl font-semibold tracking-tight text-slate-950">Instrument</h2>
              </div>
              {!loading && (
                <span className="premium-pill">{instrument.length} {instrument.length === 1 ? "product" : "products"}</span>
              )}
            </div>
            ...
            {loading ? (
              ...
              <div className="empty-state mt-6">
                ...
                <h3 className="text-base font-semibold text-slate-900">No instruments found</h3>
